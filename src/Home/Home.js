  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="title"
          content="USDAO - Truly Decentralized StableCoin in Crypto World!"
        />
        <meta
          name="description"
          content="USDAO is 100% crypto-backed digital currency with fully decentralized multi collateral-backed cryptocurrency."
        />
        <meta
          name="keywords"
          content="StableCoins, digital currency, cryptocurrency, USDAO, best StableCoin, best cryptocurrency"
        />
        ...
        <meta
          property="og:title"
          content="Truly Decentralized StableCoin in Crypto World!"
        />
        <meta
        ...
        <meta property="og:url" content="https://usdao.io" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://usdao.io/seo/usdao.png" />
      ...
      <div className="banner">
        ...
        <div className="btn-wrap d-flex mt-5">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="btn btn-border-gradient ms-5 d-flex align-items-center"
          >
            <svg
              className="me-2"
              width="17"
      ...
      <div className="advantage">
        ...
        <Row>
          <Col md={6} className="advantageRow1">
            <Row className="gy-5">
              <Col md={12}>
